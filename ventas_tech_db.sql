...
-- Crear las cuatro tablas, según su dependencia (primero las que no dependen de nadie).
...
-- Cargar 25 registros, en orden (primero las tablas sin dependencias).
...
-- Cerrar el script con las siguientes cuatro consultas.
